...
from backend.app.weather_service import WeatherService, get_weather_service
from backend.app.auth_db import init_db, create_user, get_user_by_email, get_user_by_id
...
async def disaster_alerts(
    ...
    """
    from backend.app.disaster_tools import get_disaster_alerts
...
async def approve_alert(
    ...
    try:
        ...
        from backend.app.alert_dispatcher import dispatch_approved_alert as _dispatch
...
try:
    from backend.app.weathergpt_expert import WeatherGPTExpert, get_expert
