...
from backend.app.language_manager import (
    normalize_lang_code,
    prepare_for_nlu,
...
async def generate_alert_draft(
    ...
    *,
    ...
    """
    from backend.app.language_manager import normalize_lang_code
    from backend.app.system_prompt import ALERT_DRAFT_PROMPT
    ...
    if lang != "english":
        from backend.app.language_manager import translate_to_native
